insert into customers(lastname,firstname,email,role,password,address,city,state,zip,country) values
('Schmitt','Carine','sc@tmail.com','Customer','password','54, rue Royale','Nantes',NULL,'44000','France'),
('King', 'Jean','kj@mail.com','Customer','password','8489 Strong St.','Las Vegas','NV','83030','USA'),
('Labrune', 'Janine','janine@tmail.com','Customer','password','67, rue des Cerises','Nantes',NULL,'44000','France');
